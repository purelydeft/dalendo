...
#  end
  ...
  def self.savingproject(paramsdata)
   ...
   @connection = ActiveRecord::Base.connection
   result      = @connection.exec_query("INSERT INTO projects (category_id, project_type , project_title, project_image, short_desp,  	project_location, project_startdate, project_enddate, projectlanguage, currency, project_minimum_fundinggoal, project_funding_goal, user_id, status,  	created_by,
updated_by, created_at, updated_at, project_location_latitude, project_location_longitude) VALUES ('#$category_id', '#$project_type', '#$project_title', '#$original_filename', '#$short_desp', '#$project_location', '#$project_startdate', '#$project_enddate', '#$project_language', '#$currency', '#$project_minimum_fundinggoal', '#$project_funding_goal', '#$user_id', '#$status', '#$created_by', '#$updated_by', '#$created_at', '#$updated_at', '#$project_location_latitude', '#$project_location_longitude')")
