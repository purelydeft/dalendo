...
#        render plain: params.inspect
  ...
  def searchprojects
    ...
    #render plain: sortby.inspect
    
    global_function()
    @Get_Projects_By_Cat_id = Project.paginate(:page => params[:page], :per_page => 4).where(category_id: cat_id)
    
#    @Get_Projects_By_Cat_id = ProjectLike.globalmethod(params)
